...
<img src="{{page.image_folder}}/output_5_0.png" align="center" style: "background-color: red;">
...
$$ y_{pred} = \hat{y} = \hat{\beta}_0  + \hat{\beta}_1 x  + \hat{\beta}_2 e^x $$
...
Would we have more data, the **estimated** $$\beta_1$$ coefficient for x1, should get closer to 0.
